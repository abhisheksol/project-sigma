...
from .serializers import (
    UserAuthUserModelForgotPasswordMobileSerializer,
...
class UserAuthUserModelForgotPasswordMobileAPIView(
    CoreGenericPutAPIView,
    CoreGenericDeleteAPIView,
    CoreGenericListCreateAPIView,
    ...
    def get_serializer_class(self):
        return {
            "POST": UserAuthUserModelForgotPasswordMobileSerializer,
        }.get(self.request.method)


# class UserAuthUserModelResetPasswordMobileAPIView(
#     CoreGenericPutAPIView, generics.GenericAPIView
# ):
#     queryset = get_user_model().objects.all()
...
#     def get_serializer_class(self):
#         serializer_class = {
#             "PUT": UserAuthUserModelResetPasswordMobileSerializer,
#         }
#         return serializer_class.get(self.request.method)
